...
declare module 'djs-selfbot-v11' {
	...
	export class Client extends EventEmitter {
		...
		public on(event: 'channelRecipientAdd', listener: (channel: GroupDMChannel, user: User) => void): this;
		public on(event: 'channelRecipientRemove', listener: (channel: GroupDMChannel, user: User) => void): this;
		...
		public on(event: 'friendPresenceUpdate', listener: (oldPresence: User, newPresence: User) => void): this;
		...
		public once(event: 'channelRecipientAdd', listener: (channel: GroupDMChannel, user: User) => void): this;
		public once(event: 'channelRecipientRemove', listener: (channel: GroupDMChannel, user: User) => void): this;
		...
		public once(event: 'friendPresenceUpdate', listener: (oldPresence: User, newPresence: User) => void): this;
	...
	export class ClientUser extends User {
		...
		public pending: Collection<Snowflake, User>;
		public outgoing: Collection<Snowflake, User>;
		...
		public setCustomStatus(status: CustomStatus | CustomStatusOptions): Promise<object>;
		public patchCustomStatus(data?: CustomStatusPatchData | null): Promise<object>;
		public updateCustomStatus(data?: CustomStatusPatchData | null): Promise<ClientUser>;
		...
		/** @deprecated Use {@link ClientUser#setPresence} */
		public setPresence2(data: PresenceData): Promise<ClientUser>;
	...
	export class Guild {
		...
		public fetchMemberList(channel: GuildChannel,
			offset?: number,
			double?: boolean,
			retryMax?: number,
			time?: number,): Promise<Guild>;
		...
		public setVanityCode(code: string): Promise<string>;
		public sync(): void;
		public toString(): string;
	...
	export class Message {
		...
		public clickButton(customId: string): Promise<void>;
	...
	export class RichPresence {
		...
		public type: ActivityType | number;
		public url: string | null;
		public flags: number | null;
		public platform: ActivityPlatform | null;
		public session_id: string | null;
		public metadata: { button_urls: string[] } | null;
		public setAssetsLargeImage(image?: Snowflake | string | null): this;
		public setAssetsLargeText(text?: string): this;
		public setAssetsSmallImage(image?: Snowflake | string | null): this;
		public setAssetsSmallText(text?: string): this;
		public setName(name?: string): this;
		public setURL(url?: string): this;
		public setType(type?: ActivityType | number): this;
		...
		public setParty(party?: { size: [number, number]; id?: string } | null): this;
		public setStartTimestamp(timestamp?: number): this;
		public setEndTimestamp(timestamp?: number): this;
		public setButtons(...button: RichButton[]): this;
		public addButton(name: string, url: string): this;
		public setPlatform(platform?: ActivityPlatform | null): this;
		public setSessionId(sessionId?: string): this;
		public setFlags(flags?: number): this;
		public toJSON(): object;
		public toDiscord(): { game: object };
		public static getExternal(client: Client, applicationId: Snowflake, image1?: string, image2?: string): Promise<ExternalAssets[]>;
	}
	...
	export class CustomStatus {
		public constructor(data?: CustomStatusOptions | object, client?: Client);
		...
		public syncToAccount(client: Client): Promise<object>;
		public toJSON(): object;
	...
	export class User extends PartialTextBasedChannel() {
		...
		public setFriendNickname(nick: string): Promise<User>;
	}
	...
	type TextBasedChannelFields = {
		...
		sendSlash(botOrApplicationId: string | Snowflake, commandNameString: string, ...args: any[]): Promise<void>;
	...
	type GuildChannelType = 'category' | 'text' | 'voice' | 'news' | 'store' | 'forum' | 'stage';
	...
	type PresenceData = {
		...
		afk?: boolean;
		activities?: Array<RichPresence | CustomStatus | SpotifyRPC | ActivityOptions>;
		game?: {
			name?: string;
			url?: string;
	...
	type ActivityOptions = PresenceData['game'];

	type CustomStatusOptions = {
		name?: string;
		state?: string | null;
		details?: string | null;
		emoji?: {
	...
	type CustomStatusPatchData = {
		state?: string | null;
		emoji?: CustomStatusOptions['emoji'];
	};
