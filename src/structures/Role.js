...
class Role {
  ...
  get iconURL() {
    ...
    return Constants.Endpoints.CDN(this.client.options.http.cdn).RoleIcon(this.id, this.icon);
  }
  ...
  hasPermission(permission, explicit = false, checkAdmin) {
    return new Permissions(BigInt(this.permissions)).has(
  ...
  hasPermissions(permissions, explicit = false) {
    return new Permissions(BigInt(this.permissions)).has(permissions, !explicit);
  }
