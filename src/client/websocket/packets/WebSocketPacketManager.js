...
class WebSocketPacketManager {
  constructor(connection) {
    ...
    this.register(Constants.WSEvents.CHANNEL_RECIPIENT_ADD, require('./handlers/ChannelRecipientAdd'));
    this.register(Constants.WSEvents.CHANNEL_RECIPIENT_REMOVE, require('./handlers/ChannelRecipientRemove'));
